...
export const forgotMailHtml = (tokenActive: any) => {
  const urlLogIn = tokenActive;
  return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body style="margin: 0; padding: 0">
        <div class="content">
          ...
          <div class="text">
            You can log in using this email (valid for 1 hour).
          </div>
          <div class="button">
            <a
              href="${urlLogIn}"
          ...
          <div class="description">
            If you didn’t foget but received this email, let us know
          ...
          <div class="contact">
            <div class="icon">
              <a href="${LINK.HELP}" style="color:black; text-decoration: none"
                >Help</a
              >
            </div>
            <div class="icon">
              <a href="${LINK.TERMS}" style="color:black; text-decoration: none"
                >Terms</a
              >
            </div>
            <div class="icon">
              <a href="${LINK.PRIVACY}" style="color:black; text-decoration: none"
                >Privacy</a
              >
            </div>
            <div class="icon">
              <a href="${LINK.FACEBOOK}" style="color:black; text-decoration: none"
                >Facebook</a
              >
            </div>
            <div class="icon">
              <a href="${LINK.REDDIT}" style="color:black; text-decoration: none"
                >Reddit</a
              >
            </div>
            <div class="icon">
              <a href="${LINK.LIKEDIN}" style="color:black; text-decoration: none"
                >Likedin</a
              >
            </div>
          </div>
